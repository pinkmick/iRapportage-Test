...
package irapportage.ibz_cipers_drop_ldf_views_0_1;
...
/**
 * Job: ibz_cipers_drop_ldf_views Purpose: <br>
 * Description: Drop all views of iRapportage in the LDF. <br>
 * @author user@talend.com
 * @version 6.3.1.20161216_1026
 * @status 
 */
public class ibz_cipers_drop_ldf_views implements TalendJob {
...
public String getMks_port(){
	...
	private final String jobName = "ibz_cipers_drop_ldf_views";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				ibz_cipers_drop_ldf_views.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(ibz_cipers_drop_ldf_views.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class mksStruct implements routines.system.IPersistableRow<mksStruct> {
    final static byte[] commonByteArrayLock_IRAPPORTAGE_ibz_cipers_drop_ldf_views = new byte[0];
    static byte[] commonByteArray_IRAPPORTAGE_ibz_cipers_drop_ldf_views = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_IRAPPORTAGE_ibz_cipers_drop_ldf_views.length) {
				if(length < 1024 && commonByteArray_IRAPPORTAGE_ibz_cipers_drop_ldf_views.length == 0) {
   					commonByteArray_IRAPPORTAGE_ibz_cipers_drop_ldf_views = new byte[1024];
				} else {
   					commonByteArray_IRAPPORTAGE_ibz_cipers_drop_ldf_views = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_IRAPPORTAGE_ibz_cipers_drop_ldf_views, 0, length);
			strReturn = new String(commonByteArray_IRAPPORTAGE_ibz_cipers_drop_ldf_views, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_IRAPPORTAGE_ibz_cipers_drop_ldf_views) {
...
query_tPostgresqlRow_1 = "drop view if exists ldf.ibz_cip_view_personen";
...
query_tPostgresqlRow_2 = "drop view if exists ldf.ibz_cip_view_ouders1";
...
query_tPostgresqlRow_3 = "drop view if exists ldf.ibz_cip_view_ouders2";
...
query_tPostgresqlRow_4 = "drop view if exists ldf.ibz_cip_view_nationaliteiten";
...
query_tPostgresqlRow_5 = "drop view if exists ldf.ibz_cip_view_huwelijken";
...
query_tPostgresqlRow_6 = "drop view if exists ldf.ibz_cip_view_overlijdens";
...
query_tPostgresqlRow_7 = "drop view if exists ldf.ibz_cip_view_verblijfplaatsen";
...
query_tPostgresqlRow_8 = "drop view if exists ldf.ibz_cip_view_kinderen";
...
query_tPostgresqlRow_9 = "drop view if exists ldf.ibz_cip_view_verblijfstitels";
...
query_tPostgresqlRow_10 = "drop view if exists ldf.ibz_cip_view_gezagsverhoudingen";
 ...
 */
    ...
    public static void main(String[] args){
        final ibz_cipers_drop_ldf_views ibz_cipers_drop_ldf_viewsClass = new ibz_cipers_drop_ldf_views();

        int exitCode = ibz_cipers_drop_ldf_viewsClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = ibz_cipers_drop_ldf_views.class.getClassLoader().getResourceAsStream("irapportage/ibz_cipers_drop_ldf_views_0_1/contexts/"+contextStr+".properties");
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : ibz_cipers_drop_ldf_views");
        }
...
/************************************************************************************************
 *     88836 characters generated by Talend Open Studio for Data Integration 
 *     on the 18 oktober 2018 12:24:55 CEST
 ************************************************************************************************/