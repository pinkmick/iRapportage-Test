...
package irapportage.ibz_cipers_drop_ldf_functies_0_1;
...
/**
 * Job: ibz_cipers_drop_ldf_functies Purpose: Drop functions of iRapportage<br>
 * Description: Drop all function of iRapportage <br>
 * @author user@talend.com
 * @version 6.3.1.20161216_1026
 * @status 
 */
public class ibz_cipers_drop_ldf_functies implements TalendJob {
...
public String getMks_port(){
	...
	private final String jobName = "ibz_cipers_drop_ldf_functies";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				ibz_cipers_drop_ldf_functies.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(ibz_cipers_drop_ldf_functies.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class mksStruct implements routines.system.IPersistableRow<mksStruct> {
    final static byte[] commonByteArrayLock_IRAPPORTAGE_ibz_cipers_drop_ldf_functies = new byte[0];
    static byte[] commonByteArray_IRAPPORTAGE_ibz_cipers_drop_ldf_functies = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_IRAPPORTAGE_ibz_cipers_drop_ldf_functies.length) {
				if(length < 1024 && commonByteArray_IRAPPORTAGE_ibz_cipers_drop_ldf_functies.length == 0) {
   					commonByteArray_IRAPPORTAGE_ibz_cipers_drop_ldf_functies = new byte[1024];
				} else {
   					commonByteArray_IRAPPORTAGE_ibz_cipers_drop_ldf_functies = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_IRAPPORTAGE_ibz_cipers_drop_ldf_functies, 0, length);
			strReturn = new String(commonByteArray_IRAPPORTAGE_ibz_cipers_drop_ldf_functies, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_IRAPPORTAGE_ibz_cipers_drop_ldf_functies) {
...
query_tPostgresqlRow_1 = "drop function if exists ldf.ibz_leeftijd_in_jaren(geboortedatum date,datum date)";
...
query_tPostgresqlRow_2 = "drop function if exists ldf.ibz_datum_naar_jaar(datum date)";
...
query_tPostgresqlRow_3 = "drop function if exists ldf.ibz_datum_naar_jaarmaand(datum date)";
...
query_tPostgresqlRow_4 = "drop function if exists ldf.ibz_datum_naar_jaarmaanddag(datum date)";
...
query_tPostgresqlRow_5 = "drop function if exists ldf.ibz_datum_tussen_strings_incl(datum_start character, datum date,\n  datum_eind character)";
...
query_tPostgresqlRow_6 = "drop function if exists ldf.ibz_opgemaaktedatum(datum date, indicator text, formaat boolean)";
 ...
 */
    ...
    public static void main(String[] args){
        final ibz_cipers_drop_ldf_functies ibz_cipers_drop_ldf_functiesClass = new ibz_cipers_drop_ldf_functies();

        int exitCode = ibz_cipers_drop_ldf_functiesClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = ibz_cipers_drop_ldf_functies.class.getClassLoader().getResourceAsStream("irapportage/ibz_cipers_drop_ldf_functies_0_1/contexts/"+contextStr+".properties");
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : ibz_cipers_drop_ldf_functies");
        }
...
/************************************************************************************************
 *     67729 characters generated by Talend Open Studio for Data Integration 
