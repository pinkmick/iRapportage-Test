...
package irapportage.ibz_cipers_fill_ldf_ouder2_historie_0_1;
...
/**
 * Job: ibz_cipers_fill_ldf_ouder2_historie Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 6.3.1.20161216_1026
 * @status 
 */
public class ibz_cipers_fill_ldf_ouder2_historie implements TalendJob {
...
public String getMks_port(){
	...
	private final String jobName = "ibz_cipers_fill_ldf_ouder2_historie";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				ibz_cipers_fill_ldf_ouder2_historie.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(ibz_cipers_fill_ldf_ouder2_historie.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class cipersStruct implements routines.system.IPersistableRow<cipersStruct> {
    final static byte[] commonByteArrayLock_IRAPPORTAGE_ibz_cipers_fill_ldf_ouder2_historie = new byte[0];
    static byte[] commonByteArray_IRAPPORTAGE_ibz_cipers_fill_ldf_ouder2_historie = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_IRAPPORTAGE_ibz_cipers_fill_ldf_ouder2_historie.length) {
				if(length < 1024 && commonByteArray_IRAPPORTAGE_ibz_cipers_fill_ldf_ouder2_historie.length == 0) {
   					commonByteArray_IRAPPORTAGE_ibz_cipers_fill_ldf_ouder2_historie = new byte[1024];
				} else {
   					commonByteArray_IRAPPORTAGE_ibz_cipers_fill_ldf_ouder2_historie = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_IRAPPORTAGE_ibz_cipers_fill_ldf_ouder2_historie, 0, length);
			strReturn = new String(commonByteArray_IRAPPORTAGE_ibz_cipers_fill_ldf_ouder2_historie, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_IRAPPORTAGE_ibz_cipers_fill_ldf_ouder2_historie) {
...
public static class ldf_ouder2_historieStruct implements routines.system.IPersistableRow<ldf_ouder2_historieStruct> {
    final static byte[] commonByteArrayLock_IRAPPORTAGE_ibz_cipers_fill_ldf_ouder2_historie = new byte[0];
    static byte[] commonByteArray_IRAPPORTAGE_ibz_cipers_fill_ldf_ouder2_historie = new byte[0];
    ...
    public String loopKey;
			    ...
			    public String ou2hstgeslachtsaanduidingomschrijving;

				public String getOu2hstgeslachtsaanduidingomschrijving () {
					return this.ou2hstgeslachtsaanduidingomschrijving;
				}
			    ...
			    public String ou2hstregistergemeenteaktecode;

				public String getOu2hstregistergemeenteaktecode () {
					return this.ou2hstregistergemeenteaktecode;
				}
				
			    public String ou2hstregistergemeenteakteomschrijving;

				public String getOu2hstregistergemeenteakteomschrijving () {
					return this.ou2hstregistergemeenteakteomschrijving;
				}
				
			    public String ou2hstaktenummer;

				public String getOu2hstaktenummer () {
					return this.ou2hstaktenummer;
				}
				
			    public String ou2hstgemeentedocumentcode;

				public String getOu2hstgemeentedocumentcode () {
					return this.ou2hstgemeentedocumentcode;
				}
				
			    public String ou2hstgemeentedocumentomschrijving;

				public String getOu2hstgemeentedocumentomschrijving () {
					return this.ou2hstgemeentedocumentomschrijving;
				}
				
			    public java.util.Date ou2hstdatumdocument;

				public java.util.Date getOu2hstdatumdocument () {
					return this.ou2hstdatumdocument;
				}
				
			    public String ou2hstdatumdocumentindicator;

				public String getOu2hstdatumdocumentindicator () {
					return this.ou2hstdatumdocumentindicator;
				}
				
			    public String ou2hstbeschrijvingdocument;

				public String getOu2hstbeschrijvingdocument () {
					return this.ou2hstbeschrijvingdocument;
				}
				
			    public BigDecimal ou2hstaanduidinggegevensonderzoek;

				public BigDecimal getOu2hstaanduidinggegevensonderzoek () {
					return this.ou2hstaanduidinggegevensonderzoek;
				}
				
			    public java.util.Date ou2hstdatumingangonderzoek;

				public java.util.Date getOu2hstdatumingangonderzoek () {
					return this.ou2hstdatumingangonderzoek;
				}
				
			    public String ou2hstdatumingangonderzoekindicator;

				public String getOu2hstdatumingangonderzoekindicator () {
					return this.ou2hstdatumingangonderzoekindicator;
				}
				
			    public java.util.Date ou2hstdatumeindeonderzoek;

				public java.util.Date getOu2hstdatumeindeonderzoek () {
					return this.ou2hstdatumeindeonderzoek;
				}
				
			    public String ou2hstdatumeindeonderzoekindicator;

				public String getOu2hstdatumeindeonderzoekindicator () {
					return this.ou2hstdatumeindeonderzoekindicator;
				}
	...
	public boolean equals(Object obj) {
		...
		final ldf_ouder2_historieStruct other = (ldf_ouder2_historieStruct) obj;
	...
	public void copyDataTo(ldf_ouder2_historieStruct other) {
		...
		other.prsanummer = this.prsanummer;
	            ...
	            other.ou2hstgeslachtsaanduidingomschrijving = this.ou2hstgeslachtsaanduidingomschrijving;
	            ...
	            other.ou2hstregistergemeenteaktecode = this.ou2hstregistergemeenteaktecode;
	            other.ou2hstregistergemeenteakteomschrijving = this.ou2hstregistergemeenteakteomschrijving;
	            other.ou2hstaktenummer = this.ou2hstaktenummer;
	            other.ou2hstgemeentedocumentcode = this.ou2hstgemeentedocumentcode;
	            other.ou2hstgemeentedocumentomschrijving = this.ou2hstgemeentedocumentomschrijving;
	            other.ou2hstdatumdocument = this.ou2hstdatumdocument;
	            other.ou2hstdatumdocumentindicator = this.ou2hstdatumdocumentindicator;
	            other.ou2hstbeschrijvingdocument = this.ou2hstbeschrijvingdocument;
	            other.ou2hstaanduidinggegevensonderzoek = this.ou2hstaanduidinggegevensonderzoek;
	            other.ou2hstdatumingangonderzoek = this.ou2hstdatumingangonderzoek;
	            other.ou2hstdatumingangonderzoekindicator = this.ou2hstdatumingangonderzoekindicator;
	            other.ou2hstdatumeindeonderzoek = this.ou2hstdatumeindeonderzoek;
	            other.ou2hstdatumeindeonderzoekindicator = this.ou2hstdatumeindeonderzoekindicator;
	...
	public void copyKeysDataTo(ldf_ouder2_historieStruct other) {
		...
		synchronized(commonByteArrayLock_IRAPPORTAGE_ibz_cipers_fill_ldf_ouder2_historie) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.ou2hstgeslachtsaanduidingomschrijving = readString(dis);
					...
					this.ou2hstregistergemeenteaktecode = readString(dis);
					
					this.ou2hstregistergemeenteakteomschrijving = readString(dis);
					
					this.ou2hstaktenummer = readString(dis);
					
					this.ou2hstgemeentedocumentcode = readString(dis);
					
					this.ou2hstgemeentedocumentomschrijving = readString(dis);
					
					this.ou2hstdatumdocument = readDate(dis);
					
					this.ou2hstdatumdocumentindicator = readString(dis);
					
					this.ou2hstbeschrijvingdocument = readString(dis);
					
						this.ou2hstaanduidinggegevensonderzoek = (BigDecimal) dis.readObject();
					
					this.ou2hstdatumingangonderzoek = readDate(dis);
					
					this.ou2hstdatumingangonderzoekindicator = readString(dis);
					
					this.ou2hstdatumeindeonderzoek = readDate(dis);
					
					this.ou2hstdatumeindeonderzoekindicator = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.ou2hstgeslachtsaanduidingomschrijving,dos);
					...
					// String
						...
						writeString(this.ou2hstregistergemeenteaktecode,dos);
					
					// String
				
						writeString(this.ou2hstregistergemeenteakteomschrijving,dos);
					
					// String
				
						writeString(this.ou2hstaktenummer,dos);
					
					// String
				
						writeString(this.ou2hstgemeentedocumentcode,dos);
					
					// String
				
						writeString(this.ou2hstgemeentedocumentomschrijving,dos);
					
					// java.util.Date
				
						writeDate(this.ou2hstdatumdocument,dos);
					
					// String
				
						writeString(this.ou2hstdatumdocumentindicator,dos);
					
					// String
				
						writeString(this.ou2hstbeschrijvingdocument,dos);
					
					// BigDecimal
				
       			    	dos.writeObject(this.ou2hstaanduidinggegevensonderzoek);
					
					// java.util.Date
				
						writeDate(this.ou2hstdatumingangonderzoek,dos);
					
					// String
				
						writeString(this.ou2hstdatumingangonderzoekindicator,dos);
					
					// java.util.Date
				
						writeDate(this.ou2hstdatumeindeonderzoek,dos);
					
					// String
				
						writeString(this.ou2hstdatumeindeonderzoekindicator,dos);
    ...
    public String toString() {
		...
		sb.append(",ou2hstgeslachtsaanduidingomschrijving="+ou2hstgeslachtsaanduidingomschrijving);
		...
		sb.append(",ou2hstregistergemeenteaktecode="+ou2hstregistergemeenteaktecode);
		sb.append(",ou2hstregistergemeenteakteomschrijving="+ou2hstregistergemeenteakteomschrijving);
		sb.append(",ou2hstaktenummer="+ou2hstaktenummer);
		sb.append(",ou2hstgemeentedocumentcode="+ou2hstgemeentedocumentcode);
		sb.append(",ou2hstgemeentedocumentomschrijving="+ou2hstgemeentedocumentomschrijving);
		sb.append(",ou2hstdatumdocument="+String.valueOf(ou2hstdatumdocument));
		sb.append(",ou2hstdatumdocumentindicator="+ou2hstdatumdocumentindicator);
		sb.append(",ou2hstbeschrijvingdocument="+ou2hstbeschrijvingdocument);
		sb.append(",ou2hstaanduidinggegevensonderzoek="+String.valueOf(ou2hstaanduidinggegevensonderzoek));
		sb.append(",ou2hstdatumingangonderzoek="+String.valueOf(ou2hstdatumingangonderzoek));
		sb.append(",ou2hstdatumingangonderzoekindicator="+ou2hstdatumingangonderzoekindicator);
		sb.append(",ou2hstdatumeindeonderzoek="+String.valueOf(ou2hstdatumeindeonderzoek));
		sb.append(",ou2hstdatumeindeonderzoekindicator="+ou2hstdatumeindeonderzoekindicator);
     ...
     * Compare keys
     */
    public int compareTo(ldf_ouder2_historieStruct other) {
...
public static class cipers_ouder2_historieStruct implements routines.system.IPersistableRow<cipers_ouder2_historieStruct> {
    final static byte[] commonByteArrayLock_IRAPPORTAGE_ibz_cipers_fill_ldf_ouder2_historie = new byte[0];
    static byte[] commonByteArray_IRAPPORTAGE_ibz_cipers_fill_ldf_ouder2_historie = new byte[0];
     ...
     * Compare keys
     */
    public int compareTo(cipers_ouder2_historieStruct other) {
...
public void tAS400Input_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	try {
		...
		cipers_ouder2_historieStruct cipers_ouder2_historie = new cipers_ouder2_historieStruct();
ldf_ouder2_historieStruct ldf_ouder2_historie = new ldf_ouder2_historieStruct();
	...
	currentComponent="tPostgresqlOutput_1";
			...
			if (execStat) {
				if(resourceMap.get("inIterateVComp") == null){
						...
						runStat.updateStatOnConnection("ldf_ouder2_historie" + iterateId, 0, 0);
...
if(dbschema_tPostgresqlOutput_1 == null || dbschema_tPostgresqlOutput_1.trim().length() == 0) {
	tableName_tPostgresqlOutput_1 = "ibz_cip_ouder2_historie";
} else {
	tableName_tPostgresqlOutput_1 = dbschema_tPostgresqlOutput_1 + "\".\"" + "ibz_cip_ouder2_historie";
}
...
int count_tPostgresqlOutput_1=0;
	    String insert_tPostgresqlOutput_1 = "INSERT INTO \"" + tableName_tPostgresqlOutput_1 + "\" (\"prsanummer\",\"ou2hstsleutelgeldigdatum\",\"ou2hstsleutelgeldigvolgnummer\",\"ou2hstanummer\",\"ou2hstburgerservicenummer\",\"ou2hstvoornamen\",\"ou2hstvoorletters\",\"ou2hstadellijketitelcode\",\"ou2hstadellijketitelomschrijving\",\"ou2hstvoorvoegselgeslachtsnaam\",\"ou2hstgeslachtsnaam\",\"ou2hstgeboortedatum\",\"ou2hstgeboortedatumindicator\",\"ou2hstgeboorteplaatscode\",\"ou2hstgeboorteplaatsomschrijving\",\"ou2hstgeboortelandcode\",\"ou2hstgeboortelandomschrijving\",\"ou2hstgeslachtsaanduidingcode\",\"ou2hstgeslachtsaanduidingomschrijving\",\"ou2hstdatumingangfamilierechtelijkebetrekking\",\"ou2hstdatumingangfamilierechtelijkebetrekkingindicator\",\"ou2hstregistergemeenteaktecode\",\"ou2hstregistergemeenteakteomschrijving\",\"ou2hstaktenummer\",\"ou2hstgemeentedocumentcode\",\"ou2hstgemeentedocumentomschrijving\",\"ou2hstdatumdocument\",\"ou2hstdatumdocumentindicator\",\"ou2hstbeschrijvingdocument\",\"ou2hstaanduidinggegevensonderzoek\",\"ou2hstdatumingangonderzoek\",\"ou2hstdatumingangonderzoekindicator\",\"ou2hstdatumeindeonderzoek\",\"ou2hstdatumeindeonderzoekindicator\",\"ou2hstingangsdatumgeldigheid\",\"ou2hstingangsdatumgeldigheidindicator\",\"ou2hstdatumvanopneming\",\"ou2hstdatumvanopnemingindicator\") VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
	...
	currentComponent="tMap_1";
			...
			if (execStat) {
				if(resourceMap.get("inIterateVComp") == null){
						...
						runStat.updateStatOnConnection("cipers_ouder2_historie" + iterateId, 0, 0);
...
ldf_ouder2_historieStruct ldf_ouder2_historie_tmp = new ldf_ouder2_historieStruct();
// ###############################
 ...
 */
	...
	final String decryptedPassword_tAS400Input_1 = context.cip_password; 
		    ...
		    String dbquery_tAS400Input_1 = "select\n prsAnummer,\n ou2hstSleutelGeldigDatum,\n ou2hstSleutelGeldigVolgnummer,\n ou2hstAnummer,\n ou2hstBurgerservicenummer,\n rtrim(ou2hstVoornamen) as ou2hstVoornamen,\n rtrim(ou2hstVoorletters) as ou2hstVoorletters,\n rtrim(ou2hstAdellijketitelCode) as ou2hstAdellijketitelCode,\n rtrim(ou2hstVoorvoegselGeslachtsnaam) as ou2hstVoorvoegselGeslachtsnaam,\n rtrim(ou2hstGeslachtsnaam) as ou2hstGeslachtsnaam,\n ou2hstGeboortedatum,\n ou2hstGeboortedatumIndicator,\n rtrim(ou2hstGeboorteplaatsCode) as ou2hstGeboorteplaatsCode,\n rtrim(ou2hstGeboorteplaatsOmschrijving) as ou2hstGeboorteplaatsOmschrijving,\n rtrim(ou2hstGeboortelandCode) as ou2hstGeboortelandCode,\n rtrim(ou2hstGeslachtsaanduidingCode) as ou2hstGeslachtsaanduidingCode,\n ou2hstDatumIngangFamilierechtelijkeBetrekking,\n ou2hstDatumIngangFamilierechtelijkeBetrekkingIndicator,\n rtrim(ou2hstRegistergemeenteAkteCode) as ou2hstRegistergemeenteAkteCode,\n rtrim(ou2hstAktenummer) as ou2hstAktenummer,\n rtrim(ou2hstGemeenteDocumentCode) as ou2hstGemeenteDocumentCode,\n ou2hstDatumDocument,\n ou2hstDatumDocumentIndicator,\n rtrim(ou2hstBeschrijvingDocument) as ou2hstBeschrijvingDocument,\n ou2hstAanduidingGegevensOnderzoek,\n ou2hstDatumIngangOnderzoek,\n ou2hstDatumIngangOnderzoekIndicator,\n ou2hstDatumEindeOnderzoek,\n ou2hstDatumEindeOnderzoekIndicator,\n ou2hstIngangsdatumGeldigheid,\n ou2hstIngangsdatumGeldigheidIndicator,\n ou2hstDatumVanOpneming,\n ou2hstDatumVanOpnemingIndicator\n  from bzsc53q00";
		    ...
		    while (rs_tAS400Input_1.next()) {
		        nb_line_tAS400Input_1++;
							...
							if(colQtyInRs_tAS400Input_1 < 1) {
								cipers_ouder2_historie.PRSANUMMER = null;
							} else {
		                          
            if(rs_tAS400Input_1.getObject(1) != null) {
                cipers_ouder2_historie.PRSANUMMER = rs_tAS400Input_1.getBigDecimal(1);
            } else {
                    cipers_ouder2_historie.PRSANUMMER = null;
            }
		                    }
							if(colQtyInRs_tAS400Input_1 < 2) {
								cipers_ouder2_historie.OU2HSTSLEUTELGELDIGDATUM = null;
							} else {
		                          
            if(rs_tAS400Input_1.getObject(2) != null) {
                cipers_ouder2_historie.OU2HSTSLEUTELGELDIGDATUM = rs_tAS400Input_1.getBigDecimal(2);
            } else {
                    cipers_ouder2_historie.OU2HSTSLEUTELGELDIGDATUM = null;
            }
		                    }
							if(colQtyInRs_tAS400Input_1 < 3) {
								cipers_ouder2_historie.OU2HSTSLEUTELGELDIGVOLGNUMMER = null;
							} else {
		                          
            if(rs_tAS400Input_1.getObject(3) != null) {
                cipers_ouder2_historie.OU2HSTSLEUTELGELDIGVOLGNUMMER = rs_tAS400Input_1.getBigDecimal(3);
            } else {
                    cipers_ouder2_historie.OU2HSTSLEUTELGELDIGVOLGNUMMER = null;
            }
		                    }
							if(colQtyInRs_tAS400Input_1 < 4) {
								cipers_ouder2_historie.OU2HSTANUMMER = null;
							} else {
		                          
            if(rs_tAS400Input_1.getObject(4) != null) {
                cipers_ouder2_historie.OU2HSTANUMMER = rs_tAS400Input_1.getBigDecimal(4);
            } else {
                    cipers_ouder2_historie.OU2HSTANUMMER = null;
            }
		                    }
							if(colQtyInRs_tAS400Input_1 < 5) {
								cipers_ouder2_historie.OU2HSTBURGERSERVICENUMMER = null;
							} else {
		                          
            if(rs_tAS400Input_1.getObject(5) != null) {
                cipers_ouder2_historie.OU2HSTBURGERSERVICENUMMER = rs_tAS400Input_1.getBigDecimal(5);
            } else {
                    cipers_ouder2_historie.OU2HSTBURGERSERVICENUMMER = null;
            }
		                    }
							if(colQtyInRs_tAS400Input_1 < 6) {
								cipers_ouder2_historie.OU2HSTVOORNAMEN = null;
							} else {
	                         		
        	cipers_ouder2_historie.OU2HSTVOORNAMEN = routines.system.JDBCUtil.getString(rs_tAS400Input_1, 6, false);
		                    }
							if(colQtyInRs_tAS400Input_1 < 7) {
								cipers_ouder2_historie.OU2HSTVOORLETTERS = null;
							} else {
	                         		
        	cipers_ouder2_historie.OU2HSTVOORLETTERS = routines.system.JDBCUtil.getString(rs_tAS400Input_1, 7, false);
		                    }
							if(colQtyInRs_tAS400Input_1 < 8) {
								cipers_ouder2_historie.OU2HSTADELLIJKETITELCODE = null;
							} else {
	                         		
        	cipers_ouder2_historie.OU2HSTADELLIJKETITELCODE = routines.system.JDBCUtil.getString(rs_tAS400Input_1, 8, false);
		                    }
							if(colQtyInRs_tAS400Input_1 < 9) {
								cipers_ouder2_historie.OU2HSTVOORVOEGSELGESLACHTSNAAM = null;
							} else {
	                         		
        	cipers_ouder2_historie.OU2HSTVOORVOEGSELGESLACHTSNAAM = routines.system.JDBCUtil.getString(rs_tAS400Input_1, 9, false);
		                    }
							if(colQtyInRs_tAS400Input_1 < 10) {
								cipers_ouder2_historie.OU2HSTGESLACHTSNAAM = null;
							} else {
	                         		
        	cipers_ouder2_historie.OU2HSTGESLACHTSNAAM = routines.system.JDBCUtil.getString(rs_tAS400Input_1, 10, false);
		                    }
							if(colQtyInRs_tAS400Input_1 < 11) {
								cipers_ouder2_historie.OU2HSTGEBOORTEDATUM = null;
							} else {
										
			cipers_ouder2_historie.OU2HSTGEBOORTEDATUM = routines.system.JDBCUtil.getDate(rs_tAS400Input_1, 11);
		                    }
							if(colQtyInRs_tAS400Input_1 < 12) {
								cipers_ouder2_historie.OU2HSTGEBOORTEDATUMINDICATOR = null;
							} else {
	                         		
        	cipers_ouder2_historie.OU2HSTGEBOORTEDATUMINDICATOR = routines.system.JDBCUtil.getString(rs_tAS400Input_1, 12, false);
		                    }
							if(colQtyInRs_tAS400Input_1 < 13) {
								cipers_ouder2_historie.OU2HSTGEBOORTEPLAATSCODE = null;
							} else {
	                         		
        	cipers_ouder2_historie.OU2HSTGEBOORTEPLAATSCODE = routines.system.JDBCUtil.getString(rs_tAS400Input_1, 13, false);
		                    }
							if(colQtyInRs_tAS400Input_1 < 14) {
								cipers_ouder2_historie.OU2HSTGEBOORTEPLAATSOMSCHRIJVING = null;
							} else {
	                         		
        	cipers_ouder2_historie.OU2HSTGEBOORTEPLAATSOMSCHRIJVING = routines.system.JDBCUtil.getString(rs_tAS400Input_1, 14, false);
		                    }
							if(colQtyInRs_tAS400Input_1 < 15) {
								cipers_ouder2_historie.OU2HSTGEBOORTELANDCODE = null;
							} else {
	                         		
        	cipers_ouder2_historie.OU2HSTGEBOORTELANDCODE = routines.system.JDBCUtil.getString(rs_tAS400Input_1, 15, false);
		                    }
							if(colQtyInRs_tAS400Input_1 < 16) {
								cipers_ouder2_historie.OU2HSTGESLACHTSAANDUIDINGCODE = null;
							} else {
	                         		
        	cipers_ouder2_historie.OU2HSTGESLACHTSAANDUIDINGCODE = routines.system.JDBCUtil.getString(rs_tAS400Input_1, 16, false);
		                    }
							if(colQtyInRs_tAS400Input_1 < 17) {
								cipers_ouder2_historie.OU2HSTDATUMINGANGFAMILIERECHTELIJKEBETREKKING = null;
							} else {
										
			cipers_ouder2_historie.OU2HSTDATUMINGANGFAMILIERECHTELIJKEBETREKKING = routines.system.JDBCUtil.getDate(rs_tAS400Input_1, 17);
		                    }
							if(colQtyInRs_tAS400Input_1 < 18) {
								cipers_ouder2_historie.OU2HSTDATUMINGANGFAMILIERECHTELIJKEBETREKKINGINDICATOR = null;
							} else {
	                         		
        	cipers_ouder2_historie.OU2HSTDATUMINGANGFAMILIERECHTELIJKEBETREKKINGINDICATOR = routines.system.JDBCUtil.getString(rs_tAS400Input_1, 18, false);
		                    }
							if(colQtyInRs_tAS400Input_1 < 19) {
								cipers_ouder2_historie.OU2HSTREGISTERGEMEENTEAKTECODE = null;
							} else {
	                         		
        	cipers_ouder2_historie.OU2HSTREGISTERGEMEENTEAKTECODE = routines.system.JDBCUtil.getString(rs_tAS400Input_1, 19, false);
		                    }
							if(colQtyInRs_tAS400Input_1 < 20) {
								cipers_ouder2_historie.OU2HSTAKTENUMMER = null;
							} else {
	                         		
        	cipers_ouder2_historie.OU2HSTAKTENUMMER = routines.system.JDBCUtil.getString(rs_tAS400Input_1, 20, false);
		                    }
							if(colQtyInRs_tAS400Input_1 < 21) {
								cipers_ouder2_historie.OU2HSTGEMEENTEDOCUMENTCODE = null;
							} else {
	                         		
        	cipers_ouder2_historie.OU2HSTGEMEENTEDOCUMENTCODE = routines.system.JDBCUtil.getString(rs_tAS400Input_1, 21, false);
		                    }
							if(colQtyInRs_tAS400Input_1 < 22) {
								cipers_ouder2_historie.OU2HSTDATUMDOCUMENT = null;
							} else {
										
			cipers_ouder2_historie.OU2HSTDATUMDOCUMENT = routines.system.JDBCUtil.getDate(rs_tAS400Input_1, 22);
		                    }
							if(colQtyInRs_tAS400Input_1 < 23) {
								cipers_ouder2_historie.OU2HSTDATUMDOCUMENTINDICATOR = null;
							} else {
	                         		
        	cipers_ouder2_historie.OU2HSTDATUMDOCUMENTINDICATOR = routines.system.JDBCUtil.getString(rs_tAS400Input_1, 23, false);
		                    }
							if(colQtyInRs_tAS400Input_1 < 24) {
								cipers_ouder2_historie.OU2HSTBESCHRIJVINGDOCUMENT = null;
							} else {
	                         		
        	cipers_ouder2_historie.OU2HSTBESCHRIJVINGDOCUMENT = routines.system.JDBCUtil.getString(rs_tAS400Input_1, 24, false);
		                    }
							if(colQtyInRs_tAS400Input_1 < 25) {
								cipers_ouder2_historie.OU2HSTAANDUIDINGGEGEVENSONDERZOEK = null;
							} else {
		                          
            if(rs_tAS400Input_1.getObject(25) != null) {
                cipers_ouder2_historie.OU2HSTAANDUIDINGGEGEVENSONDERZOEK = rs_tAS400Input_1.getBigDecimal(25);
            } else {
                    cipers_ouder2_historie.OU2HSTAANDUIDINGGEGEVENSONDERZOEK = null;
            }
		                    }
							if(colQtyInRs_tAS400Input_1 < 26) {
								cipers_ouder2_historie.OU2HSTDATUMINGANGONDERZOEK = null;
							} else {
										
			cipers_ouder2_historie.OU2HSTDATUMINGANGONDERZOEK = routines.system.JDBCUtil.getDate(rs_tAS400Input_1, 26);
		                    }
							if(colQtyInRs_tAS400Input_1 < 27) {
								cipers_ouder2_historie.OU2HSTDATUMINGANGONDERZOEKINDICATOR = null;
							} else {
	                         		
        	cipers_ouder2_historie.OU2HSTDATUMINGANGONDERZOEKINDICATOR = routines.system.JDBCUtil.getString(rs_tAS400Input_1, 27, false);
		                    }
							if(colQtyInRs_tAS400Input_1 < 28) {
								cipers_ouder2_historie.OU2HSTDATUMEINDEONDERZOEK = null;
							} else {
										
			cipers_ouder2_historie.OU2HSTDATUMEINDEONDERZOEK = routines.system.JDBCUtil.getDate(rs_tAS400Input_1, 28);
		                    }
							if(colQtyInRs_tAS400Input_1 < 29) {
								cipers_ouder2_historie.OU2HSTDATUMEINDEONDERZOEKINDICATOR = null;
							} else {
	                         		
        	cipers_ouder2_historie.OU2HSTDATUMEINDEONDERZOEKINDICATOR = routines.system.JDBCUtil.getString(rs_tAS400Input_1, 29, false);
		                    }
							if(colQtyInRs_tAS400Input_1 < 30) {
								cipers_ouder2_historie.OU2HSTINGANGSDATUMGELDIGHEID = null;
							} else {
										
			cipers_ouder2_historie.OU2HSTINGANGSDATUMGELDIGHEID = routines.system.JDBCUtil.getDate(rs_tAS400Input_1, 30);
		                    }
							if(colQtyInRs_tAS400Input_1 < 31) {
								cipers_ouder2_historie.OU2HSTINGANGSDATUMGELDIGHEIDINDICATOR = null;
							} else {
	                         		
        	cipers_ouder2_historie.OU2HSTINGANGSDATUMGELDIGHEIDINDICATOR = routines.system.JDBCUtil.getString(rs_tAS400Input_1, 31, false);
		                    }
							if(colQtyInRs_tAS400Input_1 < 32) {
								cipers_ouder2_historie.OU2HSTDATUMVANOPNEMING = null;
							} else {
										
			cipers_ouder2_historie.OU2HSTDATUMVANOPNEMING = routines.system.JDBCUtil.getDate(rs_tAS400Input_1, 32);
		                    }
							if(colQtyInRs_tAS400Input_1 < 33) {
								cipers_ouder2_historie.OU2HSTDATUMVANOPNEMINGINDICATOR = null;
							} else {
	                         		
        	cipers_ouder2_historie.OU2HSTDATUMVANOPNEMINGINDICATOR = routines.system.JDBCUtil.getString(rs_tAS400Input_1, 33, false);
		                    }
 ...
 */
	...
	currentComponent="tMap_1";
			...
			//cipers_ouder2_historie
			//cipers_ouder2_historie


			
				if(execStat){
					runStat.updateStatOnConnection("cipers_ouder2_historie"+iterateId,1, 1);
				} 
 					    ...
 					    boolean forceLoopldf_titels_predikaten_ouder2_naam = false;
 							...
 							ldf_titels_predikaten_ouder2_naamStruct ldf_titels_predikaten_ouder2_naamObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
                        		    		...
                        		    		ldf_titels_predikaten_ouder2_naamHashKey.adellijketitelcode = cipers_ouder2_historie.OU2HSTADELLIJKETITELCODE ;
 					    ...
 					    boolean forceLoopldf_landen_ouder2_geboorte = false;
 							...
 							ldf_landen_ouder2_geboorteStruct ldf_landen_ouder2_geboorteObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
                        		    		...
                        		    		ldf_landen_ouder2_geboorteHashKey.landcode = cipers_ouder2_historie.OU2HSTGEBOORTELANDCODE ;
 					    ...
 					    boolean forceLoopldf_geslachtsaanduidingen_ouder2_geslacht = false;
 							...
 							ldf_geslachtsaanduidingen_ouder2_geslachtStruct ldf_geslachtsaanduidingen_ouder2_geslachtObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
                        		    		...
                        		    		ldf_geslachtsaanduidingen_ouder2_geslachtHashKey.geslachtsaanduidingcode = cipers_ouder2_historie.OU2HSTGESLACHTSAANDUIDINGCODE ;
 					    ...
 					    boolean forceLoopldf_gemeenten_ouder2_akte = false;
 							...
 							ldf_gemeenten_ouder2_akteStruct ldf_gemeenten_ouder2_akteObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
                        		    		...
                        		    		ldf_gemeenten_ouder2_akteHashKey.gemeentecode = cipers_ouder2_historie.OU2HSTREGISTERGEMEENTEAKTECODE ;
 					    ...
 					    boolean forceLoopldf_gemeenten_ouder2_document = false;
 							...
 							ldf_gemeenten_ouder2_documentStruct ldf_gemeenten_ouder2_documentObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
                        		    		...
                        		    		ldf_gemeenten_ouder2_documentHashKey.gemeentecode = cipers_ouder2_historie.OU2HSTGEMEENTEDOCUMENTCODE ;
...
ldf_ouder2_historie = null;


// # Output table : 'ldf_ouder2_historie'
ldf_ouder2_historie_tmp.prsanummer = cipers_ouder2_historie.PRSANUMMER;
ldf_ouder2_historie_tmp.ou2hstsleutelgeldigdatum = cipers_ouder2_historie.OU2HSTSLEUTELGELDIGDATUM;
ldf_ouder2_historie_tmp.ou2hstsleutelgeldigvolgnummer = cipers_ouder2_historie.OU2HSTSLEUTELGELDIGVOLGNUMMER;
ldf_ouder2_historie_tmp.ou2hstanummer = cipers_ouder2_historie.OU2HSTANUMMER;
ldf_ouder2_historie_tmp.ou2hstburgerservicenummer = cipers_ouder2_historie.OU2HSTBURGERSERVICENUMMER;
ldf_ouder2_historie_tmp.ou2hstvoornamen = cipers_ouder2_historie.OU2HSTVOORNAMEN;
ldf_ouder2_historie_tmp.ou2hstvoorletters = cipers_ouder2_historie.OU2HSTVOORLETTERS;
ldf_ouder2_historie_tmp.ou2hstadellijketitelcode = cipers_ouder2_historie.OU2HSTADELLIJKETITELCODE;
ldf_ouder2_historie_tmp.ou2hstadellijketitelomschrijving = ldf_titels_predikaten_ouder2_naam.adellijketitelomschrijving ;
ldf_ouder2_historie_tmp.ou2hstvoorvoegselgeslachtsnaam = cipers_ouder2_historie.OU2HSTVOORVOEGSELGESLACHTSNAAM;
ldf_ouder2_historie_tmp.ou2hstgeslachtsnaam = cipers_ouder2_historie.OU2HSTGESLACHTSNAAM;
ldf_ouder2_historie_tmp.ou2hstgeboortedatum = cipers_ouder2_historie.OU2HSTGEBOORTEDATUM;
ldf_ouder2_historie_tmp.ou2hstgeboortedatumindicator = cipers_ouder2_historie.OU2HSTGEBOORTEDATUMINDICATOR;
ldf_ouder2_historie_tmp.ou2hstgeboorteplaatscode = cipers_ouder2_historie.OU2HSTGEBOORTEPLAATSCODE;
ldf_ouder2_historie_tmp.ou2hstgeboorteplaatsomschrijving = cipers_ouder2_historie.OU2HSTGEBOORTEPLAATSOMSCHRIJVING;
ldf_ouder2_historie_tmp.ou2hstgeboortelandcode = cipers_ouder2_historie.OU2HSTGEBOORTELANDCODE;
ldf_ouder2_historie_tmp.ou2hstgeboortelandomschrijving = ldf_landen_ouder2_geboorte.landomschrijving ;
ldf_ouder2_historie_tmp.ou2hstgeslachtsaanduidingcode = cipers_ouder2_historie.OU2HSTGESLACHTSAANDUIDINGCODE;
ldf_ouder2_historie_tmp.ou2hstgeslachtsaanduidingomschrijving = ldf_geslachtsaanduidingen_ouder2_geslacht.geslachtsaanduidingomschrijving ;
ldf_ouder2_historie_tmp.ou2hstdatumingangfamilierechtelijkebetrekking = cipers_ouder2_historie.OU2HSTDATUMINGANGFAMILIERECHTELIJKEBETREKKING;
ldf_ouder2_historie_tmp.ou2hstdatumingangfamilierechtelijkebetrekkingindicator = cipers_ouder2_historie.OU2HSTDATUMINGANGFAMILIERECHTELIJKEBETREKKINGINDICATOR;
ldf_ouder2_historie_tmp.ou2hstregistergemeenteaktecode = cipers_ouder2_historie.OU2HSTREGISTERGEMEENTEAKTECODE;
ldf_ouder2_historie_tmp.ou2hstregistergemeenteakteomschrijving = ldf_gemeenten_ouder2_akte.gemeenteomschrijving ;
ldf_ouder2_historie_tmp.ou2hstaktenummer = cipers_ouder2_historie.OU2HSTAKTENUMMER;
ldf_ouder2_historie_tmp.ou2hstgemeentedocumentcode = cipers_ouder2_historie.OU2HSTGEMEENTEDOCUMENTCODE;
ldf_ouder2_historie_tmp.ou2hstgemeentedocumentomschrijving = ldf_gemeenten_ouder2_document.gemeenteomschrijving ;
ldf_ouder2_historie_tmp.ou2hstdatumdocument = cipers_ouder2_historie.OU2HSTDATUMDOCUMENT;
ldf_ouder2_historie_tmp.ou2hstdatumdocumentindicator = cipers_ouder2_historie.OU2HSTDATUMDOCUMENTINDICATOR;
ldf_ouder2_historie_tmp.ou2hstbeschrijvingdocument = cipers_ouder2_historie.OU2HSTBESCHRIJVINGDOCUMENT;
ldf_ouder2_historie_tmp.ou2hstaanduidinggegevensonderzoek = cipers_ouder2_historie.OU2HSTAANDUIDINGGEGEVENSONDERZOEK;
ldf_ouder2_historie_tmp.ou2hstdatumingangonderzoek = cipers_ouder2_historie.OU2HSTDATUMINGANGONDERZOEK;
ldf_ouder2_historie_tmp.ou2hstdatumingangonderzoekindicator = cipers_ouder2_historie.OU2HSTDATUMINGANGONDERZOEKINDICATOR;
ldf_ouder2_historie_tmp.ou2hstdatumeindeonderzoek = cipers_ouder2_historie.OU2HSTDATUMEINDEONDERZOEK;
ldf_ouder2_historie_tmp.ou2hstdatumeindeonderzoekindicator = cipers_ouder2_historie.OU2HSTDATUMEINDEONDERZOEKINDICATOR;
ldf_ouder2_historie_tmp.ou2hstingangsdatumgeldigheid = cipers_ouder2_historie.OU2HSTINGANGSDATUMGELDIGHEID;
ldf_ouder2_historie_tmp.ou2hstingangsdatumgeldigheidindicator = cipers_ouder2_historie.OU2HSTINGANGSDATUMGELDIGHEIDINDICATOR;
ldf_ouder2_historie_tmp.ou2hstdatumvanopneming = cipers_ouder2_historie.OU2HSTDATUMVANOPNEMING;
ldf_ouder2_historie_tmp.ou2hstdatumvanopnemingindicator = cipers_ouder2_historie.OU2HSTDATUMVANOPNEMINGINDICATOR;
ldf_ouder2_historie = ldf_ouder2_historie_tmp;
// ###############################
 ...
 * [tMap_1 main ] stop
 */
// Start of branch "ldf_ouder2_historie"
if(ldf_ouder2_historie != null) { 
	...
	currentComponent="tPostgresqlOutput_1";
			...
			//ldf_ouder2_historie
				...
				if(execStat){
					runStat.updateStatOnConnection("ldf_ouder2_historie"+iterateId,1, 1);
				} 
        ...
        whetherReject_tPostgresqlOutput_1 = false;
                    pstmt_tPostgresqlOutput_1.setBigDecimal(1, ldf_ouder2_historie.prsanummer);

                    pstmt_tPostgresqlOutput_1.setBigDecimal(2, ldf_ouder2_historie.ou2hstsleutelgeldigdatum);

                    pstmt_tPostgresqlOutput_1.setBigDecimal(3, ldf_ouder2_historie.ou2hstsleutelgeldigvolgnummer);

                    pstmt_tPostgresqlOutput_1.setBigDecimal(4, ldf_ouder2_historie.ou2hstanummer);

                    pstmt_tPostgresqlOutput_1.setBigDecimal(5, ldf_ouder2_historie.ou2hstburgerservicenummer);

                    if(ldf_ouder2_historie.ou2hstvoornamen == null) {
pstmt_tPostgresqlOutput_1.setNull(6, java.sql.Types.VARCHAR);
} else {pstmt_tPostgresqlOutput_1.setString(6, ldf_ouder2_historie.ou2hstvoornamen);
}

                    if(ldf_ouder2_historie.ou2hstvoorletters == null) {
pstmt_tPostgresqlOutput_1.setNull(7, java.sql.Types.VARCHAR);
} else {pstmt_tPostgresqlOutput_1.setString(7, ldf_ouder2_historie.ou2hstvoorletters);
}

                    if(ldf_ouder2_historie.ou2hstadellijketitelcode == null) {
pstmt_tPostgresqlOutput_1.setNull(8, java.sql.Types.VARCHAR);
} else {pstmt_tPostgresqlOutput_1.setString(8, ldf_ouder2_historie.ou2hstadellijketitelcode);
}

                    if(ldf_ouder2_historie.ou2hstadellijketitelomschrijving == null) {
pstmt_tPostgresqlOutput_1.setNull(9, java.sql.Types.VARCHAR);
} else {pstmt_tPostgresqlOutput_1.setString(9, ldf_ouder2_historie.ou2hstadellijketitelomschrijving);
}

                    if(ldf_ouder2_historie.ou2hstvoorvoegselgeslachtsnaam == null) {
pstmt_tPostgresqlOutput_1.setNull(10, java.sql.Types.VARCHAR);
} else {pstmt_tPostgresqlOutput_1.setString(10, ldf_ouder2_historie.ou2hstvoorvoegselgeslachtsnaam);
}

                    if(ldf_ouder2_historie.ou2hstgeslachtsnaam == null) {
pstmt_tPostgresqlOutput_1.setNull(11, java.sql.Types.VARCHAR);
} else {pstmt_tPostgresqlOutput_1.setString(11, ldf_ouder2_historie.ou2hstgeslachtsnaam);
}

                    if(ldf_ouder2_historie.ou2hstgeboortedatum != null) {
pstmt_tPostgresqlOutput_1.setTimestamp(12, new java.sql.Timestamp(ldf_ouder2_historie.ou2hstgeboortedatum.getTime()));
} else {
pstmt_tPostgresqlOutput_1.setNull(12, java.sql.Types.TIMESTAMP);
}

                    if(ldf_ouder2_historie.ou2hstgeboortedatumindicator == null) {
pstmt_tPostgresqlOutput_1.setNull(13, java.sql.Types.VARCHAR);
} else {pstmt_tPostgresqlOutput_1.setString(13, ldf_ouder2_historie.ou2hstgeboortedatumindicator);
}

                    if(ldf_ouder2_historie.ou2hstgeboorteplaatscode == null) {
pstmt_tPostgresqlOutput_1.setNull(14, java.sql.Types.VARCHAR);
} else {pstmt_tPostgresqlOutput_1.setString(14, ldf_ouder2_historie.ou2hstgeboorteplaatscode);
}

                    if(ldf_ouder2_historie.ou2hstgeboorteplaatsomschrijving == null) {
pstmt_tPostgresqlOutput_1.setNull(15, java.sql.Types.VARCHAR);
} else {pstmt_tPostgresqlOutput_1.setString(15, ldf_ouder2_historie.ou2hstgeboorteplaatsomschrijving);
}

                    if(ldf_ouder2_historie.ou2hstgeboortelandcode == null) {
pstmt_tPostgresqlOutput_1.setNull(16, java.sql.Types.VARCHAR);
} else {pstmt_tPostgresqlOutput_1.setString(16, ldf_ouder2_historie.ou2hstgeboortelandcode);
}

                    if(ldf_ouder2_historie.ou2hstgeboortelandomschrijving == null) {
pstmt_tPostgresqlOutput_1.setNull(17, java.sql.Types.VARCHAR);
} else {pstmt_tPostgresqlOutput_1.setString(17, ldf_ouder2_historie.ou2hstgeboortelandomschrijving);
}

                    if(ldf_ouder2_historie.ou2hstgeslachtsaanduidingcode == null) {
pstmt_tPostgresqlOutput_1.setNull(18, java.sql.Types.VARCHAR);
} else {pstmt_tPostgresqlOutput_1.setString(18, ldf_ouder2_historie.ou2hstgeslachtsaanduidingcode);
}

                    if(ldf_ouder2_historie.ou2hstgeslachtsaanduidingomschrijving == null) {
pstmt_tPostgresqlOutput_1.setNull(19, java.sql.Types.VARCHAR);
} else {pstmt_tPostgresqlOutput_1.setString(19, ldf_ouder2_historie.ou2hstgeslachtsaanduidingomschrijving);
}

                    if(ldf_ouder2_historie.ou2hstdatumingangfamilierechtelijkebetrekking != null) {
pstmt_tPostgresqlOutput_1.setTimestamp(20, new java.sql.Timestamp(ldf_ouder2_historie.ou2hstdatumingangfamilierechtelijkebetrekking.getTime()));
} else {
pstmt_tPostgresqlOutput_1.setNull(20, java.sql.Types.TIMESTAMP);
}

                    if(ldf_ouder2_historie.ou2hstdatumingangfamilierechtelijkebetrekkingindicator == null) {
pstmt_tPostgresqlOutput_1.setNull(21, java.sql.Types.VARCHAR);
} else {pstmt_tPostgresqlOutput_1.setString(21, ldf_ouder2_historie.ou2hstdatumingangfamilierechtelijkebetrekkingindicator);
}

                    if(ldf_ouder2_historie.ou2hstregistergemeenteaktecode == null) {
pstmt_tPostgresqlOutput_1.setNull(22, java.sql.Types.VARCHAR);
} else {pstmt_tPostgresqlOutput_1.setString(22, ldf_ouder2_historie.ou2hstregistergemeenteaktecode);
}

                    if(ldf_ouder2_historie.ou2hstregistergemeenteakteomschrijving == null) {
pstmt_tPostgresqlOutput_1.setNull(23, java.sql.Types.VARCHAR);
} else {pstmt_tPostgresqlOutput_1.setString(23, ldf_ouder2_historie.ou2hstregistergemeenteakteomschrijving);
}

                    if(ldf_ouder2_historie.ou2hstaktenummer == null) {
pstmt_tPostgresqlOutput_1.setNull(24, java.sql.Types.VARCHAR);
} else {pstmt_tPostgresqlOutput_1.setString(24, ldf_ouder2_historie.ou2hstaktenummer);
}

                    if(ldf_ouder2_historie.ou2hstgemeentedocumentcode == null) {
pstmt_tPostgresqlOutput_1.setNull(25, java.sql.Types.VARCHAR);
} else {pstmt_tPostgresqlOutput_1.setString(25, ldf_ouder2_historie.ou2hstgemeentedocumentcode);
}

                    if(ldf_ouder2_historie.ou2hstgemeentedocumentomschrijving == null) {
pstmt_tPostgresqlOutput_1.setNull(26, java.sql.Types.VARCHAR);
} else {pstmt_tPostgresqlOutput_1.setString(26, ldf_ouder2_historie.ou2hstgemeentedocumentomschrijving);
}

                    if(ldf_ouder2_historie.ou2hstdatumdocument != null) {
pstmt_tPostgresqlOutput_1.setTimestamp(27, new java.sql.Timestamp(ldf_ouder2_historie.ou2hstdatumdocument.getTime()));
} else {
pstmt_tPostgresqlOutput_1.setNull(27, java.sql.Types.TIMESTAMP);
}

                    if(ldf_ouder2_historie.ou2hstdatumdocumentindicator == null) {
pstmt_tPostgresqlOutput_1.setNull(28, java.sql.Types.VARCHAR);
} else {pstmt_tPostgresqlOutput_1.setString(28, ldf_ouder2_historie.ou2hstdatumdocumentindicator);
}

                    if(ldf_ouder2_historie.ou2hstbeschrijvingdocument == null) {
pstmt_tPostgresqlOutput_1.setNull(29, java.sql.Types.VARCHAR);
} else {pstmt_tPostgresqlOutput_1.setString(29, ldf_ouder2_historie.ou2hstbeschrijvingdocument);
}

                    pstmt_tPostgresqlOutput_1.setBigDecimal(30, ldf_ouder2_historie.ou2hstaanduidinggegevensonderzoek);

                    if(ldf_ouder2_historie.ou2hstdatumingangonderzoek != null) {
pstmt_tPostgresqlOutput_1.setTimestamp(31, new java.sql.Timestamp(ldf_ouder2_historie.ou2hstdatumingangonderzoek.getTime()));
} else {
pstmt_tPostgresqlOutput_1.setNull(31, java.sql.Types.TIMESTAMP);
}

                    if(ldf_ouder2_historie.ou2hstdatumingangonderzoekindicator == null) {
pstmt_tPostgresqlOutput_1.setNull(32, java.sql.Types.VARCHAR);
} else {pstmt_tPostgresqlOutput_1.setString(32, ldf_ouder2_historie.ou2hstdatumingangonderzoekindicator);
}

                    if(ldf_ouder2_historie.ou2hstdatumeindeonderzoek != null) {
pstmt_tPostgresqlOutput_1.setTimestamp(33, new java.sql.Timestamp(ldf_ouder2_historie.ou2hstdatumeindeonderzoek.getTime()));
} else {
pstmt_tPostgresqlOutput_1.setNull(33, java.sql.Types.TIMESTAMP);
}

                    if(ldf_ouder2_historie.ou2hstdatumeindeonderzoekindicator == null) {
pstmt_tPostgresqlOutput_1.setNull(34, java.sql.Types.VARCHAR);
} else {pstmt_tPostgresqlOutput_1.setString(34, ldf_ouder2_historie.ou2hstdatumeindeonderzoekindicator);
}

                    if(ldf_ouder2_historie.ou2hstingangsdatumgeldigheid != null) {
pstmt_tPostgresqlOutput_1.setTimestamp(35, new java.sql.Timestamp(ldf_ouder2_historie.ou2hstingangsdatumgeldigheid.getTime()));
} else {
pstmt_tPostgresqlOutput_1.setNull(35, java.sql.Types.TIMESTAMP);
}

                    if(ldf_ouder2_historie.ou2hstingangsdatumgeldigheidindicator == null) {
pstmt_tPostgresqlOutput_1.setNull(36, java.sql.Types.VARCHAR);
} else {pstmt_tPostgresqlOutput_1.setString(36, ldf_ouder2_historie.ou2hstingangsdatumgeldigheidindicator);
}

                    if(ldf_ouder2_historie.ou2hstdatumvanopneming != null) {
pstmt_tPostgresqlOutput_1.setTimestamp(37, new java.sql.Timestamp(ldf_ouder2_historie.ou2hstdatumvanopneming.getTime()));
} else {
pstmt_tPostgresqlOutput_1.setNull(37, java.sql.Types.TIMESTAMP);
}

                    if(ldf_ouder2_historie.ou2hstdatumvanopnemingindicator == null) {
pstmt_tPostgresqlOutput_1.setNull(38, java.sql.Types.VARCHAR);
} else {pstmt_tPostgresqlOutput_1.setString(38, ldf_ouder2_historie.ou2hstdatumvanopnemingindicator);
}
...
} // End of branch "ldf_ouder2_historie"
...
// ###############################      
			...
			if(execStat){
				if(resourceMap.get("inIterateVComp") == null || !((Boolean)resourceMap.get("inIterateVComp"))){
			 		runStat.updateStatOnConnection("cipers_ouder2_historie"+iterateId,2, 0); 
			 	}
			}
 ...
 */
	...
	nb_line_rejected_tPostgresqlOutput_1=nb_line_rejected_tPostgresqlOutput_1 + rejectedCount_tPostgresqlOutput_1;
        ...
        globalMap.put("tPostgresqlOutput_1_NB_LINE_REJECTED", nb_line_rejected_tPostgresqlOutput_1);
			...
			if(execStat){
				if(resourceMap.get("inIterateVComp") == null || !((Boolean)resourceMap.get("inIterateVComp"))){
			 		runStat.updateStatOnConnection("ldf_ouder2_historie"+iterateId,2, 0); 
			 	}
			}
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_ldf_titels_predikaten_ouder2_naam";
        ...
        new BytesLimit65535_tAdvancedHash_ldf_titels_predikaten_ouder2_naam().limitLog4jByte();
			   		...
			   		// source node:tPostgresqlInput_1 - inputs:(after_tAS400Input_1) outputs:(ldf_titels_predikaten_ouder2_naam,ldf_titels_predikaten_ouder2_naam) | target node:tAdvancedHash_ldf_titels_predikaten_ouder2_naam - inputs:(ldf_titels_predikaten_ouder2_naam) outputs:()
			   		// linked node: tMap_1 - inputs:(cipers_ouder2_historie,ldf_titels_predikaten_ouder2_naam,ldf_landen_ouder2_geboorte,ldf_geslachtsaanduidingen_ouder2_geslacht,ldf_gemeenten_ouder2_akte,ldf_gemeenten_ouder2_document) outputs:(ldf_ouder2_historie)
 ...
 */
	...
	final String decryptedPassword_tPostgresqlInput_1 = routines.system.PasswordEncryptUtil.decryptPassword("2b61aee32355cf5cf2e60757bd765168");
		...
		try{
        	...
        	ldf_titels_predikaten_ouder2_naam.adellijketitelcode = routines.system.JDBCUtil.getString(rs_tPostgresqlInput_1, 1, false);
		                    }
							if(colQtyInRs_tPostgresqlInput_1 < 2) {
								ldf_titels_predikaten_ouder2_naam.adellijketitelomschrijving = null;
							} else {
	                         		
        	ldf_titels_predikaten_ouder2_naam.adellijketitelomschrijving = routines.system.JDBCUtil.getString(rs_tPostgresqlInput_1, 2, false);
		                    }
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_ldf_landen_ouder2_geboorte";
        ...
        new BytesLimit65535_tAdvancedHash_ldf_landen_ouder2_geboorte().limitLog4jByte();
			   		...
			   		// source node:tPostgresqlInput_2 - inputs:(after_tAS400Input_1) outputs:(ldf_landen_ouder2_geboorte,ldf_landen_ouder2_geboorte) | target node:tAdvancedHash_ldf_landen_ouder2_geboorte - inputs:(ldf_landen_ouder2_geboorte) outputs:()
			   		// linked node: tMap_1 - inputs:(cipers_ouder2_historie,ldf_titels_predikaten_ouder2_naam,ldf_landen_ouder2_geboorte,ldf_geslachtsaanduidingen_ouder2_geslacht,ldf_gemeenten_ouder2_akte,ldf_gemeenten_ouder2_document) outputs:(ldf_ouder2_historie)
 ...
 */
	...
	final String decryptedPassword_tPostgresqlInput_2 = routines.system.PasswordEncryptUtil.decryptPassword("2b61aee32355cf5cf2e60757bd765168");
		...
		try{
        	...
        	ldf_landen_ouder2_geboorte.landcode = routines.system.JDBCUtil.getString(rs_tPostgresqlInput_2, 1, false);
		                    }
							if(colQtyInRs_tPostgresqlInput_2 < 2) {
								ldf_landen_ouder2_geboorte.landomschrijving = null;
							} else {
	                         		
        	ldf_landen_ouder2_geboorte.landomschrijving = routines.system.JDBCUtil.getString(rs_tPostgresqlInput_2, 2, false);
		                    }
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_ldf_geslachtsaanduidingen_ouder2_geslacht";
        ...
        new BytesLimit65535_tAdvancedHash_ldf_geslachtsaanduidingen_ouder2_geslacht().limitLog4jByte();
			   		...
			   		// source node:tPostgresqlInput_3 - inputs:(after_tAS400Input_1) outputs:(ldf_geslachtsaanduidingen_ouder2_geslacht,ldf_geslachtsaanduidingen_ouder2_geslacht) | target node:tAdvancedHash_ldf_geslachtsaanduidingen_ouder2_geslacht - inputs:(ldf_geslachtsaanduidingen_ouder2_geslacht) outputs:()
			   		// linked node: tMap_1 - inputs:(cipers_ouder2_historie,ldf_titels_predikaten_ouder2_naam,ldf_landen_ouder2_geboorte,ldf_geslachtsaanduidingen_ouder2_geslacht,ldf_gemeenten_ouder2_akte,ldf_gemeenten_ouder2_document) outputs:(ldf_ouder2_historie)
 ...
 */
	...
	final String decryptedPassword_tPostgresqlInput_3 = routines.system.PasswordEncryptUtil.decryptPassword("2b61aee32355cf5cf2e60757bd765168");
		...
		try{
        	...
        	ldf_geslachtsaanduidingen_ouder2_geslacht.geslachtsaanduidingcode = routines.system.JDBCUtil.getString(rs_tPostgresqlInput_3, 1, false);
		                    }
							if(colQtyInRs_tPostgresqlInput_3 < 2) {
								ldf_geslachtsaanduidingen_ouder2_geslacht.geslachtsaanduidingomschrijving = null;
							} else {
	                         		
        	ldf_geslachtsaanduidingen_ouder2_geslacht.geslachtsaanduidingomschrijving = routines.system.JDBCUtil.getString(rs_tPostgresqlInput_3, 2, false);
		                    }
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_ldf_gemeenten_ouder2_akte";
        ...
        new BytesLimit65535_tAdvancedHash_ldf_gemeenten_ouder2_akte().limitLog4jByte();
			   		...
			   		// source node:tPostgresqlInput_4 - inputs:(after_tAS400Input_1) outputs:(ldf_gemeenten_ouder2_akte,ldf_gemeenten_ouder2_akte) | target node:tAdvancedHash_ldf_gemeenten_ouder2_akte - inputs:(ldf_gemeenten_ouder2_akte) outputs:()
			   		// linked node: tMap_1 - inputs:(cipers_ouder2_historie,ldf_titels_predikaten_ouder2_naam,ldf_landen_ouder2_geboorte,ldf_geslachtsaanduidingen_ouder2_geslacht,ldf_gemeenten_ouder2_akte,ldf_gemeenten_ouder2_document) outputs:(ldf_ouder2_historie)
 ...
 */
	...
	final String decryptedPassword_tPostgresqlInput_4 = routines.system.PasswordEncryptUtil.decryptPassword("2b61aee32355cf5cf2e60757bd765168");
		...
		try{
        	...
        	ldf_gemeenten_ouder2_akte.gemeentecode = routines.system.JDBCUtil.getString(rs_tPostgresqlInput_4, 1, false);
		                    }
							if(colQtyInRs_tPostgresqlInput_4 < 2) {
								ldf_gemeenten_ouder2_akte.gemeenteomschrijving = null;
							} else {
	                         		
        	ldf_gemeenten_ouder2_akte.gemeenteomschrijving = routines.system.JDBCUtil.getString(rs_tPostgresqlInput_4, 2, false);
		                    }
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_ldf_gemeenten_ouder2_document";
        ...
        new BytesLimit65535_tAdvancedHash_ldf_gemeenten_ouder2_document().limitLog4jByte();
			   		...
			   		// source node:tPostgresqlInput_5 - inputs:(after_tAS400Input_1) outputs:(ldf_gemeenten_ouder2_document,ldf_gemeenten_ouder2_document) | target node:tAdvancedHash_ldf_gemeenten_ouder2_document - inputs:(ldf_gemeenten_ouder2_document) outputs:()
			   		// linked node: tMap_1 - inputs:(cipers_ouder2_historie,ldf_titels_predikaten_ouder2_naam,ldf_landen_ouder2_geboorte,ldf_geslachtsaanduidingen_ouder2_geslacht,ldf_gemeenten_ouder2_akte,ldf_gemeenten_ouder2_document) outputs:(ldf_ouder2_historie)
 ...
 */
	...
	final String decryptedPassword_tPostgresqlInput_5 = routines.system.PasswordEncryptUtil.decryptPassword("2b61aee32355cf5cf2e60757bd765168");
		...
		try{
        	...
        	ldf_gemeenten_ouder2_document.gemeentecode = routines.system.JDBCUtil.getString(rs_tPostgresqlInput_5, 1, false);
		                    }
							if(colQtyInRs_tPostgresqlInput_5 < 2) {
								ldf_gemeenten_ouder2_document.gemeenteomschrijving = null;
							} else {
	                         		
        	ldf_gemeenten_ouder2_document.gemeenteomschrijving = routines.system.JDBCUtil.getString(rs_tPostgresqlInput_5, 2, false);
		                    }
 ...
 */
    ...
    public static void main(String[] args){
        final ibz_cipers_fill_ldf_ouder2_historie ibz_cipers_fill_ldf_ouder2_historieClass = new ibz_cipers_fill_ldf_ouder2_historie();

        int exitCode = ibz_cipers_fill_ldf_ouder2_historieClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = ibz_cipers_fill_ldf_ouder2_historie.class.getClassLoader().getResourceAsStream("irapportage/ibz_cipers_fill_ldf_ouder2_historie_0_1/contexts/"+contextStr+".properties");
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : ibz_cipers_fill_ldf_ouder2_historie");
        }
