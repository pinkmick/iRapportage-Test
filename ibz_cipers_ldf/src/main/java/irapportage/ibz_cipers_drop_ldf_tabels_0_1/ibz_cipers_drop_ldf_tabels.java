...
package irapportage.ibz_cipers_drop_ldf_tabels_0_1;
...
/**
 * Job: ibz_cipers_drop_ldf_tabels Purpose: <br>
 * Description: Drop and create all tabels of iRapportage in the LDF. <br>
 * @author user@talend.com
 * @version 6.3.1.20161216_1026
 * @status 
 */
public class ibz_cipers_drop_ldf_tabels implements TalendJob {
...
public String getMks_port(){
	...
	private final String jobName = "ibz_cipers_drop_ldf_tabels";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				ibz_cipers_drop_ldf_tabels.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(ibz_cipers_drop_ldf_tabels.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class mksStruct implements routines.system.IPersistableRow<mksStruct> {
    final static byte[] commonByteArrayLock_IRAPPORTAGE_ibz_cipers_drop_ldf_tabels = new byte[0];
    static byte[] commonByteArray_IRAPPORTAGE_ibz_cipers_drop_ldf_tabels = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_IRAPPORTAGE_ibz_cipers_drop_ldf_tabels.length) {
				if(length < 1024 && commonByteArray_IRAPPORTAGE_ibz_cipers_drop_ldf_tabels.length == 0) {
   					commonByteArray_IRAPPORTAGE_ibz_cipers_drop_ldf_tabels = new byte[1024];
				} else {
   					commonByteArray_IRAPPORTAGE_ibz_cipers_drop_ldf_tabels = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_IRAPPORTAGE_ibz_cipers_drop_ldf_tabels, 0, length);
			strReturn = new String(commonByteArray_IRAPPORTAGE_ibz_cipers_drop_ldf_tabels, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_IRAPPORTAGE_ibz_cipers_drop_ldf_tabels) {
...
java.sql.Connection conn_tCreateTable_4= java.sql.DriverManager.getConnection(url_tCreateTable_4,dbUser_tCreateTable_4, decryptedPassword_tCreateTable_4);
            ...
            rsTable_tCreateTable_4.close();
                if(whetherExist_tCreateTable_4) {
                    java.sql.Statement stmtDrop_tCreateTable_4 = conn_tCreateTable_4.createStatement();
                    stmtDrop_tCreateTable_4.execute("DROP TABLE \"" + tableName_tCreateTable_4 + "\"");
                }
...
java.sql.Connection conn_tCreateTable_5= java.sql.DriverManager.getConnection(url_tCreateTable_5,dbUser_tCreateTable_5, decryptedPassword_tCreateTable_5);
            ...
            rsTable_tCreateTable_5.close();
                if(whetherExist_tCreateTable_5) {
                    java.sql.Statement stmtDrop_tCreateTable_5 = conn_tCreateTable_5.createStatement();
                    stmtDrop_tCreateTable_5.execute("DROP TABLE \"" + tableName_tCreateTable_5 + "\"");
                }
...
java.sql.Connection conn_tCreateTable_6= java.sql.DriverManager.getConnection(url_tCreateTable_6,dbUser_tCreateTable_6, decryptedPassword_tCreateTable_6);
            ...
            rsTable_tCreateTable_6.close();
                if(whetherExist_tCreateTable_6) {
                    java.sql.Statement stmtDrop_tCreateTable_6 = conn_tCreateTable_6.createStatement();
                    stmtDrop_tCreateTable_6.execute("DROP TABLE \"" + tableName_tCreateTable_6 + "\"");
                }
...
java.sql.Connection conn_tCreateTable_7= java.sql.DriverManager.getConnection(url_tCreateTable_7,dbUser_tCreateTable_7, decryptedPassword_tCreateTable_7);
            ...
            rsTable_tCreateTable_7.close();
                if(whetherExist_tCreateTable_7) {
                    java.sql.Statement stmtDrop_tCreateTable_7 = conn_tCreateTable_7.createStatement();
                    stmtDrop_tCreateTable_7.execute("DROP TABLE \"" + tableName_tCreateTable_7 + "\"");
                }
...
java.sql.Connection conn_tCreateTable_8= java.sql.DriverManager.getConnection(url_tCreateTable_8,dbUser_tCreateTable_8, decryptedPassword_tCreateTable_8);
            ...
            rsTable_tCreateTable_8.close();
                if(whetherExist_tCreateTable_8) {
                    java.sql.Statement stmtDrop_tCreateTable_8 = conn_tCreateTable_8.createStatement();
                    stmtDrop_tCreateTable_8.execute("DROP TABLE \"" + tableName_tCreateTable_8 + "\"");
                }
...
java.sql.Connection conn_tCreateTable_10= java.sql.DriverManager.getConnection(url_tCreateTable_10,dbUser_tCreateTable_10, decryptedPassword_tCreateTable_10);
            ...
            rsTable_tCreateTable_10.close();
                if(whetherExist_tCreateTable_10) {
                    java.sql.Statement stmtDrop_tCreateTable_10 = conn_tCreateTable_10.createStatement();
                    stmtDrop_tCreateTable_10.execute("DROP TABLE \"" + tableName_tCreateTable_10 + "\"");
                }
...
java.sql.Connection conn_tCreateTable_11= java.sql.DriverManager.getConnection(url_tCreateTable_11,dbUser_tCreateTable_11, decryptedPassword_tCreateTable_11);
            ...
            rsTable_tCreateTable_11.close();
                if(whetherExist_tCreateTable_11) {
                    java.sql.Statement stmtDrop_tCreateTable_11 = conn_tCreateTable_11.createStatement();
                    stmtDrop_tCreateTable_11.execute("DROP TABLE \"" + tableName_tCreateTable_11 + "\"");
                }
...
java.sql.Connection conn_tCreateTable_12= java.sql.DriverManager.getConnection(url_tCreateTable_12,dbUser_tCreateTable_12, decryptedPassword_tCreateTable_12);
            ...
            rsTable_tCreateTable_12.close();
                if(whetherExist_tCreateTable_12) {
                    java.sql.Statement stmtDrop_tCreateTable_12 = conn_tCreateTable_12.createStatement();
                    stmtDrop_tCreateTable_12.execute("DROP TABLE \"" + tableName_tCreateTable_12 + "\"");
                }
...
java.sql.Connection conn_tCreateTable_13= java.sql.DriverManager.getConnection(url_tCreateTable_13,dbUser_tCreateTable_13, decryptedPassword_tCreateTable_13);
            ...
            rsTable_tCreateTable_13.close();
                if(whetherExist_tCreateTable_13) {
                    java.sql.Statement stmtDrop_tCreateTable_13 = conn_tCreateTable_13.createStatement();
                    stmtDrop_tCreateTable_13.execute("DROP TABLE \"" + tableName_tCreateTable_13 + "\"");
                }
...
java.sql.Connection conn_tCreateTable_14= java.sql.DriverManager.getConnection(url_tCreateTable_14,dbUser_tCreateTable_14, decryptedPassword_tCreateTable_14);
            ...
            rsTable_tCreateTable_14.close();
                if(whetherExist_tCreateTable_14) {
                    java.sql.Statement stmtDrop_tCreateTable_14 = conn_tCreateTable_14.createStatement();
                    stmtDrop_tCreateTable_14.execute("DROP TABLE \"" + tableName_tCreateTable_14 + "\"");
                }
...
java.sql.Connection conn_tCreateTable_15= java.sql.DriverManager.getConnection(url_tCreateTable_15,dbUser_tCreateTable_15, decryptedPassword_tCreateTable_15);
            ...
            rsTable_tCreateTable_15.close();
                if(whetherExist_tCreateTable_15) {
                    java.sql.Statement stmtDrop_tCreateTable_15 = conn_tCreateTable_15.createStatement();
                    stmtDrop_tCreateTable_15.execute("DROP TABLE \"" + tableName_tCreateTable_15 + "\"");
                }
 ...
 */
    ...
    public static void main(String[] args){
        final ibz_cipers_drop_ldf_tabels ibz_cipers_drop_ldf_tabelsClass = new ibz_cipers_drop_ldf_tabels();

        int exitCode = ibz_cipers_drop_ldf_tabelsClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = ibz_cipers_drop_ldf_tabels.class.getClassLoader().getResourceAsStream("irapportage/ibz_cipers_drop_ldf_tabels_0_1/contexts/"+contextStr+".properties");
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : ibz_cipers_drop_ldf_tabels");
        }
...
/************************************************************************************************
 *     206105 characters generated by Talend Open Studio for Data Integration 
 *     on the 18 oktober 2018 12:24:56 CEST
 ************************************************************************************************/